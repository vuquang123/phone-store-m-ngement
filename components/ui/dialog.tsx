...
>(({ className, children, ...props }, ref) => {
  const hasDescription = React.Children.toArray(children).some((child: any) => {
    const t = child?.type
    return t === DialogPrimitive.Description || t?.displayName === DialogDescription.displayName
  })
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        tabIndex={-1}
        onOpenAutoFocus={(e) => {
          // Chuyển focus vào nội dung dialog ngay khi mở để tránh cảnh báo aria-hidden
          e.preventDefault()
          const el = e.currentTarget as HTMLElement
          // Defer để đảm bảo node đã mount xong
